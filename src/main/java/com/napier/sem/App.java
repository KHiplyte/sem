...
public class App
{
    public static void main(String[] args)
    {
        ...
        // Full Print of employees by salary
        ...
        ArrayList<Employee> employeesDep = a.getSalariesByDepartment(dept);

        //Display Salary Information in Specific department
        a.printSalariesByDepartment(employeesDep);
...
private Connection con = null;
    ...
    public Employee getEmployee(int ID)
    {
        try
        {
            ...
            if (rset.next())
            {
               ...
               // emp.dept = rset.getString("Department");
        ...
        try
        {
            ...
            String strSelect =
                    "SELECT employees.emp_no, employees.first_name, employees.last_name, salaries.salary "
                            ...
                            + "ORDER BY employees.emp_no ASC LIMIT 20";
            // Execute SQL statement
            ResultSet rset = stmt.executeQuery(strSelect);
    ...
    public Department getDepartment(String dept_name){
        try
        {
            ...
            String strSelect =
                    ...
                    "SELECT departments.dept_no, dept_manager.emp_no, CONCAT(employees.first_name,' ', employees.last_name) as manager "
                            ...
                            + "AND dept_manager.to_date = '9999-01-01' AND departments.dept_name = '"+ dept_name +"'" ;
     ...
     * Prints a list of employees.
     *
     * @param employeesDep The list of employees to print.
     */
    public void printSalariesByDepartment(ArrayList<Employee> employeesDep) {
        // Print header
        System.out.println(String.format("%-10s %-15s %-20s %8s", "Emp No", "First Name", "Last Name", "Salary"));
        // Loop over all employees in the list
